window.addEventListener("load", function () {
  (function ($) {
    ...
    try {
      ...
      counterCharacters("id_observation");
      copy_field_value({
      ...
      // normalize_name({ button_id: "id_email_normalize", field_id: "id_email" });
      copy_field_value({
    ...
    $("#id_email_normalize").on("click", function (event) {
        event.preventDefault();
